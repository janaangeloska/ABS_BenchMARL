...
print("Starting MADDPG training on VMAS Sampling...")

experiment_config = get_default_experiment_config()

experiment = Experiment(
    task=get_sampling_task(n_agents=3),
...
plot_learning_curves(data, experiment.folder_name, algorithm_name="MADDPG", task_name="Sampling")
